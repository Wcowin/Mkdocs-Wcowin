...
仓库地址:[https://github.com/Wcowin/Mkdocs-AI-Summary-Plus](https://github.com/Wcowin/Mkdocs-AI-Summary-Plus)  
...
**步骤1**: 下载文件
- 从 [Releases页面](https://github.com/Wcowin/Mkdocs-AI-Summary-Plus/releases) 下载最新版本
...
遇到问题？请在 [Issues](https://github.com/Wcowin/Mkdocs-AI-Summary-Plus/issues) 中反馈。
...
本项目采用 [MIT License](https://github.com/Wcowin/Mkdocs-AI-Summary-Plus/blob/main/LICENSE) 开源协议。
